<%@ page import="ubicación.UbicacionUser; gestion.General" %>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-warning" role="alert">
                    <strong>Información.</strong> Esta ubicación la obtenemos de tu libreta de direcciones o de tu dispositivo. ¿Es correcta?
                </div>
                <br>
                <div class="container">
