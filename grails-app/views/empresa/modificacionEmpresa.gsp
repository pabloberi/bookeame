...
<div id="panel-7" class="panel">
    <div class="panel-hdr">
        <h2>
            Modificación <span class="fw-300"><i>Empresa</i></span>
        </h2>
                ...
                <div class="d-flex flex-column h-100">
                    <div class="h-auto">
                        <table id="dt-basic-example" class="table table-sm m-0 w-100 h-100 border-0 table-striped table-bordered table-hover dataTable no-footer">
                            ...
                            <tbody>
                            <g:each in="${cambioDatosList}" status="i" var="empresa">
                                <tr>
                                    <td>
                                        <g:link controller="empresa" action="showCambio" id="${empresa?.id}">
