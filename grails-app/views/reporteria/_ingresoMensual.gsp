<g:if test="${ingresoTotal != null }">
    ...
    <div class="panel-content">
        <div id="js-checkbox-toggles" class="d-flex mb-3">
            ...
            <div class="custom-control custom-switch mr-2">
                ...
                <label class="custom-control-label" for="gra-1">Prepago</label>
            </div>
            <div class="custom-control custom-switch mr-2">
                <input type="checkbox" class="custom-control-input" name="gra-2" id="gra-2" checked="">
                <label class="custom-control-label" for="gra-2">Pospago</label>
            </div>
            <div class="custom-control custom-switch mr-2">
                <input type="checkbox" class="custom-control-input" name="gra-3" id="gra-3" checked="">
                <label class="custom-control-label" for="gra-3">Manual</label>
            </div>
        </div>
    ...
    <script>
        ...
        var dataSignups = [
            <g:each in="${ingresoPospago}" status="k" var="pos">
            [${pos[0]}, ${pos[1]}],
            </g:each>
        ]

        var dataManual = [
            <g:each in="${ingresoManual}" status="l" var="manual">
            [${manual[0]}, ${manual[1]}],
            </g:each>
        ]
                    ...
                    tooltipOpts:
                        {
                            ...
                            cssClass: 'tooltip-inner',
                            content: "<span class='text-warning fw-500'>%x</span>  <span class='text-success fw-500'>$ %y</span>",
                            dateFormat: "%y-%0m-%0d",
                            defaultTheme: false
                        },
                    xaxis:
