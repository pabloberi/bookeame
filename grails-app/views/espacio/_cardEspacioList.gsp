            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <div class="btn-group btn-group-sm" style="float: right;">
                        <a href="${createLink(controller: 'reserva', action: 'crearReservaUser', id: espacio?.id)}" class="btn btn-info btn-sm" title="Crear Reserva"><i class="fal fa-calendar-alt"></i></a>
                    </div>
                    </g:if>
                    <g:else>
